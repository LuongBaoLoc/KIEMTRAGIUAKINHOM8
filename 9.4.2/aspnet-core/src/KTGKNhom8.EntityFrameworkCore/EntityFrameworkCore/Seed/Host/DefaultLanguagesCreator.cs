...
namespace KTGKNhom8.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly KTGKNhom8DbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = KTGKNhom8Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(KTGKNhom8DbContext context)
        {
            _context = context;
        }
