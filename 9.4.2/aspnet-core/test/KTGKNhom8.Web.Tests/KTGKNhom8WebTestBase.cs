...
{
    public abstract class KTGKNhom8WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static KTGKNhom8WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(KTGKNhom8WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<KTGKNhom8DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<KTGKNhom8DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<KTGKNhom8DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<KTGKNhom8DbContext, Task<T>> func)
        {
            T result;
